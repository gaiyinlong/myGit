...
<html lang="zh-CN">
    ...
    <div class="layout">
        ...
        <div class="content over loginCon" id="mydiv">
            <form class="login" id="login-form" action="/user/login" method="post">
                ...
                <div class="denglu yanz fl-l" style="width:100%">
                    ...
                    <div class="fl-l y_ma" style="width:51px; height:29px;">
                        <img src="images/yanzheng1.png" alt="" width="135%"><!-- <img id="verify" src="{:U('Login/Signin/verify')}" BORDER="0" title="点击刷新验证码" style="cursor:pointer" align="absmiddle" height="30" width="60"> --></div>
                </div>
