...
<title>Insert title here</title>
  <meta charset="utf-8">
    ...
    <link type="text/css" rel="stylesheet" href="<%=basePath%>styles/jquery.news-ticker.css">
     <link type="text/css" rel="stylesheet" href="<%=basePath%>styles/jplist-custom.css">
</head>
<body>


    <div style="width:100%;height:180%;border :0px solid red;margin-top:-50px;margin-left:-45px">
		
		
					<!--BEGIN CONTENT-->
					<div  style="width: 110%" class="page-content">
						<div id="tab-general">
							<div class="row mbl">
								<div class="col-lg-12">
		...
		<script src="<%=basePath%>script/modernizr.min.js"></script>
		<script src="<%=basePath%>script/jplist.min.js"></script>
		<script src="<%=basePath%>script/jplist.js"></script>
