...
<body>
 <!--BEGIN CONTENT-->
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h4 class="mbm">
                                                                                                                    服务器状态</h4>
                                                <span class="task-item">CPU使用率 (25 - 32 cpus)<small class="pull-right text-muted">40%</small><div
                                                    class="progress progress-sm">
                                                    <div role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"
                                                        style="width: 40%;" class="progress-bar progress-bar-orange">
                                                        <span class="sr-only">40% Complete (success)</span></div>
                                                </div>
                                                </span><span>内存使用率 (2.5GB)<small class="pull-right text-muted">60%</small><div
                                                    class="progress progress-sm">
                                                    <div role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"
                                                        style="width: 60%;" class="progress-bar progress-bar-blue">
                                                        <span class="sr-only">60% Complete (success)</span></div>
                                                </div>
                                                </span><span>硬盘使用率 (C:\ 120GB , D:\ 430GB)<small class="pull-right text-muted">55%</small><div
                                                    class="progress progress-sm">
                                                ...
                                                </span><span>域名 (2/5)<small class="pull-right text-muted">66%</small><div class="progress progress-sm">
                ...
                <div id="footer">
                    <div class="copyright">
                        <a style="margin-left:auto;margin-right:auto" href="#">2017 © 无锡汉软工业智能技术有限公司</a></div>
                </div>
                <!--END FOOTER-->
            </div>
            <!--END PAGE WRAPPER-->
